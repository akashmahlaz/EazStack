...
import { 
  ...
  MessageSquare, ArrowRight, Facebook, Instagram, Linkedin, Twitter
} from "lucide-react";
...
const contactInfo = [
  ...
  { icon: Mail, label: "Email", value: "akashdalla406@gmail.com", href: "mailto:akashdalla406@gmail.com" },
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const whatsappUrl = `https://wa.me/917814002784?text=${encodeURIComponent(message)}`;
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <Seo title="Punjab Tech | Contact - Get In Touch" description="Contact Punjab Tech for mobile app development, web development, and startup consulting. Free 30-minute discovery call available." />
