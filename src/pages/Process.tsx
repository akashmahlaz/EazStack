...
const ProcessPage = () => {
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <Seo title="Punjab Tech | Process - From Idea to Launch" description="Our proven 4-phase process ensures your startup gets built right. Discovery, design, development, and launch — everything streamlined." />
        ...
        <div className="container mx-auto px-6 relative">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              A proven, streamlined process designed to minimize risk and maximize results. 
              No jargon, no confusion — just clear progress toward your goal.
            </p>
          </motion.div>
        </div>
      </section>
                    ...
                    <div className="rounded-2xl border border-border bg-card p-8 hover:shadow-warm transition-all">
                      ...
                      <ul className="space-y-3">
                        {phase.items.map((item) => (
                          <li key={item} className={`flex items-start gap-2 text-sm text-muted-foreground ${i % 2 === 0 ? 'lg:flex-row-reverse' : ''}`}>
